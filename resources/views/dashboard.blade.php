    ...
    <main>
        ...
        <div class="slider-area ">
            ...
            <div class="slider-active">
                <div class="single-slider slider-height d-flex align-items-center" data-background="assets/img/hero/seeker1.png">
                    <div class="container">
                        <div class="row">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-10">
                        <div class="cv-caption text-center">
                            ...
                            <a href="application" class="border-btn2 border-btn4">Upload your cv</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="featured-job-area feature-padding">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-10">
                        <!-- single-job-content -->
                       <span>  here we will fix the jobs available to display in this section</span>
                                <!-- Featured_job_end -->
